...
<?php $__env->startSection('content'); ?>
    <section class="home-banner-slider-area overflow-fix">
      <div class="banner-silder owl-carousel owl-theme">
        <div class="banner-silder-single-item-area overflow-fix" style="background:url(<?php echo e(asset('images/slide1.jpg')); ?>);">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="mini-about-single-area overflow-fix d-flex">  
              ...
              <div class="mini-about-single-conetnt  align-self-end overflow-fix">  
                <h5><?php echo e($totalFreelancer); ?></h5>
                <p>Freelancer</p>
              </div>
            </div>
          </div>
              ...
              <div class="also-featured owl-carousel owl-theme overflow-fix">
                <div class="also-featured-single-item overflow-fix">
                  <div class="also-featured-single-img overflow-fix d-flex align-items-center"> 
                    <img src="<?php echo e(asset('images/client1.png')); ?>"/>
                  </div>
                </div>
                <div class="also-featured-single-item overflow-fix">
                  <div class="also-featured-single-img overflow-fix d-flex align-items-center"> 
                    <img src="<?php echo e(asset('images/client2.png')); ?>"/>
                  </div>
                </div>
                <div class="also-featured-single-item overflow-fix">
                  <div class="also-featured-single-img overflow-fix d-flex align-items-center"> 
                    <img src="<?php echo e(asset('images/client3.png')); ?>"/>
                  </div>
                </div>
                <div class="also-featured-single-item overflow-fix">
                  <div class="also-featured-single-img overflow-fix d-flex align-items-center"> 
                    <img src="<?php echo e(asset('images/client4.png')); ?>"/>
                  </div>
                </div>
              </div>
            </div>
