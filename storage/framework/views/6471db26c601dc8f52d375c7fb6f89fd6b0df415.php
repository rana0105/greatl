		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="all-search-porject-count-area overflow-fix">
					...
					<?php endif; ?>
					<p><?php echo e($count); ?> projects for you</p>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="row padding-o">
							<div class="col-lg-10">
								<div class="single-porject-single-item overflow-fix">
									...
									<div class="single-porject-type overflow-fix">
										...
										?>
										<h6> <?php echo e($post->ratetype->project_type); ?> - <?php echo e($post->joblevel->job_level); ?> Level ($$) - Est. Time: <?php echo e($post->p_less); ?> - <span>Posted <?php echo e(CarbonInterval::days($days)->hours($hours)->minutes($minutes)->forHumans()); ?> ago<span></h6>
									</div>
							...
							<div class="col-lg-2 d-flex align-items-center">
								<div class="see-dtiles-button overflow-fix">
									<a href="<?php echo e(url('project-details', $post->id)); ?>" class="grren-btn">See Details</a>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function getSearchproject(category,discription,type,budget,skill) {
		...
		$.ajax({
			url:'<?php echo e(URL::to('/getProjectsearchf')); ?>',
			type: "get",
			data: {
				'category':category,
