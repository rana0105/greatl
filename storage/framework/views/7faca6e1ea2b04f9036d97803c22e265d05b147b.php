			...
			<div class="col-lg-8">
				<div class="login-freelancer-profile-setting-content-area overflow-fix">
					<div id="profile" class="box-white-bg padding-to login-freelancer-profile-setting-profile login-freelancer-profile-single-item overflow-fix">
						...
						<form class="login-freelancer-profile-single-item-content overflow-fix" role="form" action="<?php echo e(route('freelancer.profile.update')); ?>" method="POST" enctype="multipart/form-data" files="true">
					...
					<div id="contact-info" class="box-white-bg padding-to login-freelancer-profile-setting-profile login-freelancer-profile-single-item overflow-fix">
						...
						<form class="login-freelancer-profile-single-item-content overflow-fix" role="form" action="<?php echo e(route('freelancer.contact.update')); ?>" method="POST" enctype="multipart/form-data" files="true">
							<?php echo e(csrf_field()); ?>
					...
					<div id="profile-setting" class="box-white-bg padding-to login-freelancer-profile-setting-profile login-freelancer-profile-single-item overflow-fix">
						<div class="login-freelancer-profile-single-item-headding overflow-fix">
							...
							<?php if(session('successps')): ?>
								<div class="alert alert-success">
									<?php echo e(session('successps')); ?>

								</div>
							<?php endif; ?>
						</div>
						<form class="login-freelancer-profile-single-item-password overflow-fix" role="form" action="<?php echo e(route('freelancer.setting.update')); ?>" method="POST" enctype="multipart/form-data" files="true">
							<?php echo e(csrf_field()); ?>
							...
							<div id="entry" class="login-freelancer-profile-single-item-checkbox overflow-fix checkl">
								...
								<?php if($profile->level ==  'Entry Level'): ?>
								<input type="checkbox" checked=""  class="entry" name="level" value="<?php echo e($profile->level); ?>" />
								<?php endif; ?>
								<label>
									<h5>Entry Level</h5>
							...
							<div id="inter" class="login-freelancer-profile-single-item-checkbox overflow-fix checkl">
								...
								<?php if($profile->level ==  'Intermediate Level'): ?>
								<input type="checkbox" checked=""  class="inter" name="level" value="<?php echo e($profile->level); ?>" />
								<?php endif; ?>
								<label>
							...
							<div id="expert" class="login-freelancer-profile-single-item-checkbox overflow-fix checkl">
								...
								<?php if($profile->level ==  'Expert Level'): ?>
								<input type="checkbox" checked=""  class="expert" name="level" value="<?php echo e($profile->level); ?>" />
								<?php endif; ?>
								<label>
									<h5>Expert Level</h5>
									<span>A few years of professional experience in my field </span>
							...
							<div class="login-freelancer-profile-single-item-input overflow-fix">
								...
								<select class="project-categories" name="category">
									  <option value="<?php echo e($profile->project_category_id); ?>" selected="selected">--<?php echo e(isset($profile->projectcats->project_cat) ? $profile->projectcats->project_cat : 'Default'); ?>--</option>
									  ...
									  <option value="<?php echo e($p->id); ?>"><?php echo e($p->project_cat); ?></option>
									  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
							<div class="login-freelancer-profile-single-item-input overflow-fix">
					...
					<div id="myProfile" class="box-white-bg padding-to login-freelancer-profile-setting-profile login-freelancer-profile-single-item overflow-fix">
						<div class="login-freelancer-profile-single-item-headding overflow-fix">
							...
							<?php if(session('successm')): ?>
								<div class="alert alert-success">
									<?php echo e(session('successm')); ?>

								</div>
							<?php endif; ?>
						</div>
						<form class="login-freelancer-profile-single-item-content overflow-fix" role="form" action="<?php echo e(route('freelancer.myprofile.update')); ?>" method="POST" enctype="multipart/form-data" files="true">
							<?php echo e(csrf_field()); ?>

							<div class="login-freelancer-profile-single-item-input full-width overflow-fix">
								<p>Position / Designation</p>
								<input type="text" name="designation" value="<?php echo e($profile->designation); ?>" />
							</div>
							<div id="comment" class="login-freelancer-profile-single-item-input full-width overflow-fix">
								<p>Skill</p>
								<input class="required-skills" data-role="tagsinput" name="skill[]" type="text" value="<?php echo e($profile->skill); ?>" />
							...
							<div class="login-freelancer-profile-single-item-input full-width overflow-fix">
								<p>Overview</p>
								<textarea type="text" name="overview" value="<?php echo e($profile->overview); ?>"><?php echo e($profile->overview); ?></textarea>
							</div>
							<div class="login-freelancer-profile-single-item-input full-width overflow-fix">
								<p>Hourly Rate ($)</p>
								<input type="text" name="hrate" value="<?php echo e($profile->hourly_rate); ?>" />
							</div>
							<div class="login-freelancer-profile-single-item-input full-width overflow-fix">
								<p>Experience</p>
								<input type="text" name="experience" value="<?php echo e($profile->experience); ?>" />
							</div>
							<div class="login-freelancer-profile-single-item-input full-width overflow-fix">
								<p>Availability</p>
								<input type="text" name="availability" value="<?php echo e($profile->availability); ?>" />
							</div>
							<div class="form-smubit-ny overflow-fix">
								<button type="submit">Update</button>
								<a href="">Cancel</a>
					...
					<div id="profile" class="box-white-bg padding-to  login-freelancer-profile-setting-profile login-freelancer-profile-single-item overflow-fix">
						...
						<form class="login-freelancer-profile-single-item-password overflow-fix" role="form" action="<?php echo e(route('freelancer.password.update')); ?>" method="POST" enctype="multipart/form-data" files="true">
							<?php echo e(csrf_field()); ?>
