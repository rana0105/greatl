	...
	<div class="container my-container">
		<div class="row">
			<div class="col-lg-12">
				...
				<form class="singup-form overflow-fix" role="form" method="POST" action="<?php echo e(url('register')); ?>">
          ...
          <?php endif; ?>
            ...
            <?php if($errors->has('password')): ?>
                <span class="help-block errshow">
                    <strong class="errshow"><?php echo e($errors->first('password')); ?></strong>
                </span>
            <?php endif; ?>
					</div>
					<div class="singup-form-input overflow-fix">
            ...
            <?php endif; ?>
              ...
              <?php if($errors->has('privacy')): ?>
                <span class="help-block errshow">
                    <strong class="errshow"><?php echo e($errors->first('privacy')); ?></strong>
                </span>
              <?php endif; ?>
						  </span>
						</label>
