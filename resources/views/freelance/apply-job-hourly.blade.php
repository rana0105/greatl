...
<section class="project-post-page-area overflow-fix content-bg apply-this-job-area ">
	<div class="container my-container">
		<div class="row">
			<form class="col-lg-12" role="form" action="{{ url('apply-job') }}" method="POST" enctype="multipart/form-data" files="true">
				{{ csrf_field() }}
				...
				<div class="project-post-budget-info-area overflow-fix  box-white-bg">
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<span>$</span>
							<input type="number" class="servicefee" name="servicefee" readonly="" value="{{ $fee->servicefee }}" required="" />
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<span>$</span>
							<input type="text" class="getpaid" name="getpaid" readonly="" placeholder="00.00"/>
