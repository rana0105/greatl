...
<section class="project-post-page-area overflow-fix content-bg">
	<div class="container my-container">
		<div class="row">
			<form class="col-lg-12" action="{{ url('post-updated', $post->id) }}" method="POST" enctype="multipart/form-data" files="true">
				{{ csrf_field() }}
				...
				<div class="project-post-basic-info-area overflow-fix box-white-bg">
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<input type="text" name="p_title" value="{{ $post->p_title }}" />
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							{{ Form::select('p_category_id', $projectcat , $post->p_category_id, ["class" => 'project-categories'])}}
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix full-width">
							<textarea name="p_description" value="">{!! $post->p_description !!}  </textarea>
				...
				<div class="project-post-additional-info-area overflow-fix  box-white-bg">
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							{{ Form::select('p_joblevel_id', $level , $post->p_joblevel_id, ["class" => 'project-categories'])}}
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							...
							<input name="p_jobskill" class="required-skills" data-role="tagsinput" value="{{ $post->p_jobskill }}" type="text"/>
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<input  type="text" name="p_sdate" id="datepicker" value="{{ $post->p_sdate }}">
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<input  type="text" name="p_edate" id="datepicker6" value="{{ $post->p_edate }}">
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<input type="text" name="p_less" value="{{ $post->p_less }}" />
				...
				<div class="project-post-budget-info-area overflow-fix  box-white-bg">
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							{{ Form::select('p_ratetype_id', $rate , $post->p_ratetype_id, ["class" => 'project-categories'])}}
					...
					<div class="project-post-single-input overflow-fix">
						...
						<div class="project-post-input-area overflow-fix">
							<input name="p_buddget"  value="{{ $post->p_buddget }}" type="text"/>
						</div>
					</div>
				</div>
				<div class="project-post-attachment-area overflow-fix  box-white-bg">
					<div class="project-details-attachment overflow-fix">
						<ul>
						@foreach($cfile as $cf)
							<li><a href=""> <i class="fa fa-paperclip" aria-hidden="true"></i>{{ $cf->c_file }} here</a><span>x</span></li>
