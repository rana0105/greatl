	...
	<div class="col-md-6 col-md-offset-1 p-top">
		<div class="panel">
			...
			<header class="panel-heading">
					<a href="{{ URL::route('project-category.create') }}" class="btn btn-main-inv a-font">Create Rate Type</a>
			</header>
			<div class="table-responsive">
				<table class="table table-striped table-hover">
					...
					<tbody>
					<?php $sr = 1; ?>
						@foreach($projectcats as $p)
							<tr>
								<td>{{ $sr++ }}</td>
								<td>{{ $p->project_cat }}</td>
								<td>
									<a href="{{ URL::route('project-category.edit', $p->id) }}" class="btn btn-xs btn-info"><i class="fa fa-edit"></i>Edit</a>
