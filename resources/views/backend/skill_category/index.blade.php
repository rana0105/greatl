	...
	<div class="col-md-6 col-md-offset-1 p-top">
		<div class="panel">
			...
			<header class="panel-heading">
					<a href="{{ URL::route('skill-category.create') }}" class="btn btn-main-inv a-font">Create Skill Category</a>
			</header>
			<div class="table-responsive">
				<table class="table table-striped table-hover">
					...
					<tbody>
					<?php $sr = 1; ?>
						@foreach($skillcats as $s)
							<tr>
								<td>{{ $sr++ }}</td>
								<td>{{ $s->skill_category }}</td>
								<td>
									<a href="{{ URL::route('skill-category.edit', $s->id) }}" class="btn btn-xs btn-info"><i class="fa fa-edit"></i>Edit</a>
