        ...
        <ul class="nav flex-column pl-1">
          ...
          <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu1" aria-expanded="false">
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('project-category.create') }}">Add Project Category</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('project-category.index') }}">All Project Category</a></li>
            </ul>
          </li>
          <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu2" aria-expanded="false">
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('job-level.create') }}">Add Job Level</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('job-level.index') }}">All Job Level</a></li>
            </ul>
          </li>
          <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu3" aria-expanded="false">
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('rate-type.create') }}">Add Rate Type</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('rate-type.index') }}">All Rate Type</a></li>
            </ul>
          </li>
          <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu9" aria-expanded="false">
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('freelancer.payment.admin.show') }}">Freelance Payment</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('freelancer.withdraw.admin.show') }}">Freelancer Withdraw</a></li>
            </ul>
          </li>
          <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu4" aria-expanded="false">
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('skill-category.create') }}">Add Skill Category</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('skill-category.index') }}">All Skill Category</a></li>
            </ul>
          </li>
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu7" aria-expanded="false">
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('permissions.create') }}">Add Permission</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('permissions.index') }}">All Permission</a></li>
            </ul>
          </li>
          <li class="nav-item">
            ...
            <ul class="list-unstyled flex-column pl-3 collapse" id="submenu8" aria-expanded="false">
              {{-- <li class="nav-item"><a class="nav-link" href="{{ URL::route('gsetting.create') }}">Add General Setting</a></li> --}}
              <li class="nav-item"><a class="nav-link" href="{{ URL::route('gsetting.index') }}">All General Setting</a></li>
               <li class="nav-item"><a class="nav-link" href="{{ URL::route('servicefee.create') }}">Add Service Fee</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ URL::route('servicefee.index') }}">All Service Fee</a></li>
            </ul>
          </li>
        </ul>
      </div>
